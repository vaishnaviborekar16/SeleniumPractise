...
class TestPlaceOrderRegisterCheckout(BasePage):
    ...
    REGISTER_LOGIN_BUTTON = (By.XPATH, "//*[@id='checkoutModal']/div/div/div[2]/p[2]")
    ...
    LOGIN_AS_FIELD = (By.XPATH, "//*[@id='header]/div/div/div/div[2]/div/ul/li[3]/a")
    PROCEED_TO_CHECKOUT_BUTTON_AGAIN = (By.XPATH, "//*[@id='do_action']/div[1]/div/div/a")
    ...
    def fill_signup_details(self, name, email, password, day, month, year, first_name, last_name, company, address1, address2, country, state, city, zipcode, mobile):
    ...
    def verify_login_username(self):
        return self.is_element_visible(self.LOGIN_USERNAME_LABEL)
    
    def verify_cart_button(self):
        self.click(self.CART_BUTTON)

    def click_proceed_to_checkout_again(self):
        self.click(self.PROCEED_TO_CHECKOUT_BUTTON_AGAIN)
